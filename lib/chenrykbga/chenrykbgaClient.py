...
class chenrykbga(object):
    ...
    def annotate_genome(self, params, json_rpc_context = None):
        if json_rpc_context and type(json_rpc_context) is not dict:
            raise ValueError('Method annotate_genome: argument json_rpc_context is not type dict as required.')
        resp = self._call('chenrykbga.annotate_genome',
