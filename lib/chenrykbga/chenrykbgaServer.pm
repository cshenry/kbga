package chenrykbga::chenrykbgaServer;
...
our %async_run_methods = (
        'annotate_genome_async' => 'chenrykbga.annotate_genome',
);

our %async_check_methods = (
        'annotate_genome_check' => 'chenrykbga.annotate_genome',
);
...
sub call_method {
    ...
    my $ctx = chenrykbga::chenrykbgaServerContext->new($self->{loggers}->{userlog},
...
{
    # Service chenrykbga requires authentication.
	...
	{
	    $self->exception('PerlError', "Authentication required for chenrykbga but no authentication header was passed");
	}
    ...
    my @result;
    {
        ...
        my $stderr = chenrykbga::chenrykbgaServerStderrWrapper->new($ctx, $get_time);
        $ctx->stderr($stderr);
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service chenrykbga.");
    }
...
package chenrykbga::chenrykbgaServerContext;

use strict;

=head1 NAME

chenrykbga::chenrykbgaServerContext
...
package chenrykbga::chenrykbgaServerStderrWrapper;
...
unless (caller) {
    ...
    my $server = chenrykbga::chenrykbgaServer->new(
