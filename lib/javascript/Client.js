...
function chenrykbga(url, auth, auth_cb, timeout, async_job_check_time_ms) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.annotate_genome = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax("chenrykbga.annotate_genome",
